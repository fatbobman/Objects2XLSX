...
struct BookLoggerTests {
    ...
    @Test func bookWithCustomLogger() throws {
        ...
        // 验证日志被记录
        #expect(!testLogger.logMessages.isEmpty)
    ...
    @Test func bookWithDefaultLogger() throws {
        // 不提供 logger，使用默认实现
    ...
    @Test func loggerCapturingMessages() throws {
        let testLogger = TestLogger()
