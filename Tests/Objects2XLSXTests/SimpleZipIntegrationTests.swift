...
struct SimpleZipIntegrationTests {
    ...
    @Test func testCompleteXLSXGeneration() async throws {
    ...
    @Test func testXLSXWithMultipleSheets() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func testXLSXWithCustomStyles() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func testXLSXWithLargeDataset() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func testXLSXWithEmptySheet() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func testZipFileStructure() async throws {
        let book = Book(style: BookStyle())
