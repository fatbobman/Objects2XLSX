...
struct BookAPITests {
    ...
    @Test func writeMethodReturnsCorrectURL() async throws {
    ...
    @Test func writeMethodPreservesXLSXExtension() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func writeMethodReplacesIncorrectExtension() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func writeMethodCreatesParentDirectory() async throws {
        let book = Book(style: BookStyle())
    ...
    @Test func discardableResultAttribute() async throws {
        let book = Book(style: BookStyle())
