...
struct BookProgressSimpleTests {
    ...
    @Test func testProgressStreamCanBeIterated() async throws {
        let book = Book(style: BookStyle())
        
        // 简单验证迭代器可以创建
        let _ = book.progressStream.makeAsyncIterator()
