...
struct SheetMetaTests {
    ...
    func testSheetMetaWithoutHeader() {
        let meta = SheetMeta(
            name: "NoHeaderSheet",
            sheetId: 2,
            relationshipId: "rId2",
    ...
    func testDataRangeInfoExcelRange() {
        // Test single cell
    ...
    func testAnySheetMakeSheetMeta() {
        // Create test data
        let testObjects = [
    ...
    func testBookCollectSheetMetas() {
        // Create test data
        let people = [
