...
struct SimpleZipTests {
    ...
    @Test func testCreateEmptyZip() throws {
    ...
    @Test func testCreateSingleFileZip() throws {
        ...
        // 验证 ZIP 文件不为空
        #expect(zipData.count > 0, "ZIP data should not be empty")
    ...
    @Test func testCreateMultipleFilesZip() throws {
        let entries = [
    ...
    @Test func testZipWithSpecialCharacters() throws {
        let entries = [
        ...
        #expect(zipData.count > 0, "ZIP with special characters should be created")
        
        print("Special characters ZIP created: \(zipData.count) bytes")
    }
    
    @Test func testZipWithLargeFile() throws {
        // 创建一个较大的文件 (1MB)
    ...
    @Test func testXLSXLikeStructure() throws {
        // 模拟 XLSX 文件结构
        let entries = [
        ...
        #expect(zipData.count > 0, "XLSX-like ZIP should be created")
    ...
    @Test func testCRC32Calculation() throws {
        // 测试已知数据的 CRC32
    ...
    @Test func testDateTimeEncoding() throws {
        ...
        #expect(zipData.count > 0, "ZIP with specific date should be created")
